...
- Estos datos, el código y la herramienta web asociada se entregaron a la Mesa Nacional de Prioridades de Conservación en septiembre de 2026. Es posible que las actualizaciones del código y la metodología posteriores a esa fecha no se reflejen en este repositorio.
...
## Cita / contacto
Los métodos para este análisis fueron desarrollados por miembros de la Mesa Nacional de Prioridades de Conservación e implementados por integrantes del equipo DISES ECOPLAN. Las consultas sobre la creación de este código pueden dirigirse a Nickolas McManus ([nmcmanus@conservation.org](mailto:nmcmanus@conservation.org)). Las solicitudes o consultas relacionadas con actualizaciones de estos métodos o del código (posteriores a septiembre de 2026) pueden dirigirse a la Mesa Nacional ([prioridades.conservacion@parquesnacionales.gov.co](mailto:prioridades.conservacion@parquesnacionales.gov.co)).
