## script: BioModelos Matrix
## Purpose: Filter BioModelos species to those required for prioritization, 
##          then convert rasters into sparse matrix.
...
## To run for species-specific targets, format all the species ranges in a 
## sparse matrix (rather than raster stack) for running through prioritizr 

## Will generate one matrix that includes all potential spp
## Then can further filter (based on name) for specific 17 or 30 target runs

## First let's generate the list of spp using more conservative filters
...
## Make sure matches other rasters (pulled from Kevin code)
